/* Program to use PWM and analog input pin to control LED brightness*/
#include<stdio.h>
#include<unistd.h>
#include<stdlib.h>
/*The following are file and commands for analog input pin*/
FILE *AP = NULL;
char *pin_33 = "/sys/bus/iio/devices/iio:device0/in_voltage4_raw";
/*The following are file and commands for PWM pin*/
FILE *EXPO = NULL;
FILE *DIR = NULL;
...
/*Below is the program for analog input*/
while (1){
AP = fopen(pin_33,"r");
if(AP == NULL){
...
/*Below is the program for PIN setup*/
printf("\n Welcome to this program  You n select a GPIO PIN and you can control the brightness\n")
